...
import com.hdel.service.document.config.handler.CustomAuthFailureHandler;
import com.hdel.service.document.config.handler.CustomAuthSuccessHandler;
import com.hdel.service.document.config.handler.CustomAuthenticationProvider;
import com.hdel.service.document.config.filter.CustomAuthenticationFilter;
...
import com.hdel.service.document.config.filter.JwtAuthorizationFilter;
@Slf4j
@Configuration
@EnableWebSecurity
/**
