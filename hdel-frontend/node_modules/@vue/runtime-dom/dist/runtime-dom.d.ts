...
interface AriaAttributes {
  ...
  /**
   * Indicates whether inputting text could trigger display of one or more predictions of the member's intended value for an input and specifies how predictions would be
   * presented if they are made.
   */
  'aria-autocomplete'?: 'none' | 'inline' | 'list' | 'both'
  /** Indicates an element is being modified and that assistive technologies MAY want to wait until the modifications are complete before exposing them to the member. */
  ...
  /**
   * Identifies the next element (or elements) in an alternate reading order of content which, at the member's discretion,
  ...
  /** Indicates that an element will be updated, and describes the types of updates the member agents, assistive technologies, and member can expect from the live region. */
  'aria-live'?: 'off' | 'assertive' | 'polite'
  /** Indicates whether an element is modal when displayed. */
  'aria-modal'?: Booleanish
  /** Indicates whether a text box accepts multiple lines of input or only a single line. */
  'aria-multiline'?: Booleanish
  /** Indicates that the member may select more than one item from the current selectable descendants. */
  ...
  'aria-owns'?: string
  /**
   * Defines a short hint (a word or short phrase) intended to aid the member with data entry when the control has no value.
  ...
  /**
   * Indicates what notifications the member agent will trigger when the accessibility tree within a live region is modified.
   * @see aria-atomic.
   */
  'aria-relevant'?: 'additions' | 'additions text' | 'all' | 'removals' | 'text'
  /** Indicates that member input is required on the element before a form may be submitted. */
...
export interface HTMLAttributes extends AriaAttributes, EventHandlers<Events> {
  ...
  // Living Standard
  /**
   * Hints at the type of data that might be entered by the member while editing the element or its contents
...
export interface InputHTMLAttributes extends HTMLAttributes {
  ...
  autocomplete?: string
  autofocus?: Booleanish
  capture?: boolean | 'member' | 'environment' // https://www.w3.org/tr/html-media-capture/#the-capture-attribute
