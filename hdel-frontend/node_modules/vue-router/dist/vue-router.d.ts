...
/**
 * Allowed Component definitions in route records provided by the member
 */
...
export declare interface Router {
     ...
     * the member. This will trigger the initial navigation when on client side.
     *
     * @internal
...
export declare interface _RouteRecordBase extends PathParserOptions {
     ...
     * another record.
     *
     * @example `/user/:id` matches `/user/1` as well as `/user/posva`.
     */
    path: string;
    /**
     ...
     * copy of the record. Allows having paths shorthands like `/user/:id` and
...
/**
 * Possible values for a member-defined route record's name
 */
